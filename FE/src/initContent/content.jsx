...
Blockly.Blocks['wait'] = {
  init: function () {
    this.appendDummyInput()
      .appendField('wait')
      .appendField(new Blockly.FieldNumber(1, 0), 'wait')
      .appendField('seconds');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    // this.setColour(230);
...
//   init: function () {
//     this.appendDummyInput()
//       .appendField(new Blockly.FieldLabelSerializable('wait'), 'NAME')
//       .appendField(new Blockly.FieldTextInput('1'), 'NAME')
//       .appendField(new Blockly.FieldLabelSerializable('seconds'), 'NAME');
//     this.setPreviousStatement(true, null);
//     this.setNextStatement(true, null);
//     this.setColour(60);
//     this.setTooltip('');
